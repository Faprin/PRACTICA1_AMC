...
public class Algoritmos {
    ...
    /** completamente funcional
     ...
     /**
     * metodo implementado para la comodidad del usuario, asi solo tiene que preocuparse por poner el array
    ...
    /**
     * método recursivo, dividirá el arreglo tantas veces como sea necesario para ordenarlo
    ...
    /**
     * es el encargado de ordenar los subarreglos con la ayuda del pivote, en caso de que i y j sean iguales, es decir, se encuentren
     * @param t
     * @param izq
     * @param der
     * @return
